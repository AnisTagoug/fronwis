...
const ListEvent = () => {
    ...
    React.useEffect(()=>{
        axios({
            method: 'GET',
            url: `http://localhost:8089/api/event/findAll`,
                    ...
                    <StyledTable>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="center">Nombre de Place</TableCell>
                        ...
                        <TableBody>
                            ...
                            events .map((e, i) => (
                                <TableRow key={i}>
                                    ...
                                    <TableCell align="center">{e.adresse}</TableCell>
                                    <TableCell align="center">{e.nbrp}</TableCell>
                                    ...
                                    <TableCell align="right">
                                            ...
                                            {showAdd && <AddEvent setAddShow={setShowAdd} key={i}  idEvent={e.id} />}
...
/>
                                        ...
                                        <DeleteForeverIcon
                                            ...
                                            onClick={() => {
                                                axios.delete(
                                                    `http://localhost:8089/event/delete/${e.id}`
                                                );
